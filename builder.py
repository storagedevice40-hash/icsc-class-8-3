...
html_template += """
        <button class="btn-teach" onclick="enterTeachMode()">👨‍🏫 Teach Mode</button>
    </div>
...
html_template += """
        <div class="controls-hint">Left Click / Space / Right Arrow = Next Step &nbsp;|&nbsp; Right Click / Left Arrow = Previous Step &nbsp;|&nbsp; Esc = Close</div>
    </div>
